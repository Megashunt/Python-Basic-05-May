...
if __name__ == "__main__":
    ...
    #  если файла который укажет пользователь не существует то он создастся автоматически
    #  если файл существует то программа будет работать с информацией которая в нем уже была записана
